...
public class GlobalExceptionHandler {
    ...
    // Manejo de validaciones de DTOs (ejemplo: @Valid en request body)
    ...
    // Manejo de excepciones genéricas para evitar fugas de información
    @ExceptionHandler(RuntimeException.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public ResponseEntity<Map<String, String>> handleRuntimeException(RuntimeException ex) {
        Map<String, String> errorResponse = new HashMap<>();
        errorResponse.put("error", "Ha ocurrido un error inesperado.");
        errorResponse.put("detalle", ex.getMessage());  // Puedes quitar esto en producción para evitar leaks
